...
import { addToStoredReadList, addToStoredWishList } from "../Utilities/storeBook";
...
const BookDetails = () => {
    ...
    const {bookId, image, author, bookName,category,rating,review} = bookFind;
            ...
            <div className="md:flex justify-between items-center py-20 gap-8">
                ...
                <div className="">
                    ...
                    <div className="flex gap-4">
                        <button onClick={() => handleReadBookList(bookId)} className="btn">Mark as Read</button>
                        <button onClick={() => handleWishBookList(bookId)} className="btn bg-[#50B1C9] hover:bg-[#50B1C9] text-white">WishList</button>
                    </div>
                </div>
            </div>
        </div>
